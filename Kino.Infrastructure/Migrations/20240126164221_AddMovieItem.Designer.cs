...
namespace Kino.Infrastructure.Migrations
{
    ...
    [Migration("20240126164221_AddMovieItem")]
    partial class AddMovieItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kino.Domain.MovieItem.MovieItem", b =>
                {
                    b.Property<long>("MovieItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("MovieItemId"), 1L, 1);

                    b.Property<decimal>("ActualTicketPrice")
                    ...
                    b.Property<decimal>("PurchaseTicketPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Kino.Domain.MovieItem.MovieItem", b =>
                {
                    b.HasOne("Kino.Domain.Movie.Movie", "Movie")
                        .WithMany()
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
